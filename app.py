        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            if mapa_detallado_bytes:
                ...
                with open(mapa_path, 'wb') as f:
                    f.write(mapa_detallado_bytes.getvalue())
            
            # Generar PDF con la versión simple y segura
