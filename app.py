...
def calcular_metricas_ganaderas(gdf_analizado, tipo_pastura, peso_promedio, carga_animal):
    ...
    for idx, row in gdf_resultado.iterrows():
        ...
        ev_ha = biomasa_disponible_kg / consumo_diario_por_animal if consumo_diario_por_animal > 0 else 0
        
        dias_permanencia = (biomasa_disponible_kg * parametros['TASA_UTILIZACION_RECOMENDADA']) / consumo_diario_total if consumo_diario_total > 0 else 0
